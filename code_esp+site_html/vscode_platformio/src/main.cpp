...
void loop() {
  ...
  if (now - lastMsgTime > interval) {
    ...
    float iRmsA  = (iRmsData.phase[PHASE_A] * CAL_IRMS_CC) / 1000000.0f/ 2.0f;
    float powerA = (avgActivePower.phase[PHASE_A] * CAL_POWER_CC) / 1000.0f/ 2.0f;
    ...
    float iRmsB  = (iRmsData.phase[PHASE_B] * CAL_IRMS_CC) / 1000000.0f/ 2.0f;
    float powerB = (avgActivePower.phase[PHASE_B] * CAL_POWER_CC) / 1000.0f/ 2.0f;
    ...
    float iRmsC  = (iRmsData.phase[PHASE_C] * CAL_IRMS_CC) / 1000000.0f/ 2.0f;
    float powerC = (avgActivePower.phase[PHASE_C] * CAL_POWER_CC) / 1000.0f/ 2.0f;
