...
#define NOMINAL_INPUT_CURRENT 0.263      //Nominal Calibrating RMS Current on all phases (Irms)
...
#define CALIBRATION_EGY_CFG 0xF011         //Latch after EGYRDY. Sample based accumulation. Read with reset enabled (RD_RST_EN=1). Accumulation enabled
#define EGYACCTIME 0x2EDF                  //Accumulate for a total of 12000 (EGY_TIME+1) samples = 1.5 seconds at 8kHz
#define CALIBRATION_ACC_TIME 1             //Actual accumulation time depends on read rate (resets on read when RD_RST_EN=1)
...
*****************************************************************************************************************/
#define CAL_IRMS_CC		3.28849 //3.28849					// (uA/code)
